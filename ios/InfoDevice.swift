  ...
  func getinfo(_ resolve:RCTPromiseResolveBlock, reject:RCTPromiseRejectBlock){
    ...
    do {
      ...
      if let jsonString = String(data: jsonData, encoding: .utf8) {
        ...
        reject("JSON_Conversion_Error", "Erro ao converter dados JSON para string", nil)
      }
    } catch {
      reject("Serialization_Error", "Erro ao serializar dados para JSON: \(error.localizedDescription)", error)
    }
  }
